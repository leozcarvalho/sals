...
const formConfig = ref({
  ...
  baia: {
    ...
    fields: [
      { name: "name", label: "Nome", type: "text", rules: "required" },
      { name: "t1", label: "T1", component: NumericInput, props: numericProps },
      { name: "t2", label: "T2", component: NumericInput, props: numericProps },
      { name: "t3", label: "T3", component: NumericInput, props: numericProps },
      { name: "t4", label: "T4", component: NumericInput, props: numericProps },
      { name: "t5", label: "T5", component: NumericInput, props: numericProps },
      { name: "t6", label: "T6", component: NumericInput, props: numericProps },
    ],
