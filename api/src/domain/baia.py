...
class Baia(Base, table=True):
    ...
    t1: Decimal = Field(sa_column=Column(Numeric(5, 2)), default=0)
    t2: Decimal = Field(sa_column=Column(Numeric(5, 2)), default=0)
    t3: Decimal = Field(sa_column=Column(Numeric(5, 2)), default=0)
    t4: Decimal = Field(sa_column=Column(Numeric(5, 2)), default=0)
    t5: Decimal = Field(sa_column=Column(Numeric(5, 2)), default=0)
